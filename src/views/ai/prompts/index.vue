...
const sampleVars = {
  ...
  company_material_text: '【公司简介】某某科技有限公司成立多年，具备信息化项目建设、实施、运维服务能力。\n\n【项目业绩】曾参与多个类似信息化建设项目。',
  person_cert_desc: '项目经理、技术负责人及实施人员证书资料示例。',
  honor_desc: '企业荣誉、奖项、表彰资料示例。',
  implementation_team: '项目经理、技术负责人、实施工程师、售后工程师等团队配置说明。',
  team_desc: '项目团队配置及岗位职责说明。',
