...
} from './useTechnicalBidWorkflow'
import OutlineTree from '../components/OutlineTree.vue'
import WritingDirectionEditor from '../components/WritingDirectionEditor.vue'
...
export function useBidProjectPage() {
  ...
  return {
    router, auth, keyword, projectLoading, projectAppendLoading,
    projects, selectedProject, projectListScrollbar, projectPager, expandedProjectId,
    workflow, activeDoc, uploadFiles, uploadRef, technicalTenderInputRef,
    technicalTenderUploading, readTenderLoading, autoFillLoading, bidDocumentLoading, bidDocumentFilling,
    bidDocumentSaving, bidDocumentReviewSaving, bidDocumentExporting, bidDocumentDraft, bidDocumentReviewForm,
    bidDocumentDetail, companyMaterialOptions, companyMaterialDialog, tenderAnalysisDialog, tenderAnalysis,
    tenderAnalysisKnowledgeIds, enterpriseOptions, ownerUserOptions, enterpriseLoading, enterpriseKeywordTimer,
    timer, poller, technicalOutlinePoller, technicalOutlinePendingProjectId, technicalTaskPoller,
    technicalTaskPending, technicalTaskPollingBusy, technicalTaskPollErrorCount, technicalTaskPollTick, technicalTaskCanceling,
    technicalTaskTerminalNotifiedIds, globalAiRunningTask, globalAiTaskPoller, GLOBAL_AI_TASK_POLL_INTERVAL_MS, GLOBAL_AI_TASK_MIN_INTERVAL_MS,
    TECHNICAL_TASK_POLL_INTERVAL_MS, TECHNICAL_OUTLINE_POLL_INTERVAL_MS, globalAiRunningTaskPromise, lastGlobalAiRunningTaskAt, technicalSolutionRequestPromise,
    technicalSolutionRequestProjectId, workflowRefreshPromise, workflowRefreshProjectId, technicalOutlinePollingBusy, technicalOutlinePollErrorCount,
    technicalSolutionLoadErrorCount, TECH_OUTLINE_PENDING_KEY, TECH_TASK_PENDING_KEY, lastAutoExtractParseKey, wordPresetVisible,
    wordPresetSaving, wordPresetNextAction, fullGenerating, exportingWord, wordPreset,
    wordPresetSelectionValid, selectedTechnicalLeaf, technicalAutoPreviewFollow, technicalManualSelectedLeafId, technicalEditMode,
    technicalEditTab, technicalDeleteIds, technicalAddNodeVisible, technicalAddBaseNode, technicalAddNodeForm,
    technicalOverallWritingRequirement, technicalStreamingOutlineId, technicalSectionContentEditMode, technicalSectionContentDraft, technicalSectionContentSaving,
    technicalSectionEditorRef, imagePickerVisible, sectionNode, sectionDialogVisible, sectionGenerating,
    sectionOptimizing, sectionOptimizingNodeId, sectionStreamingText, technicalShortenDialogVisible, technicalShortenTargetMode,
    technicalShortenCustomWordCount, technicalShortenPresetOptions, wordOptions, sectionForm, DEFAULT_BLIND_BID_REQUIREMENT,
    fullGenerateForm, fullGenerateSettingVisible, fullGenerateAction, knowledgeSelectorVisible, knowledgeLoading,
    knowledgeKeyword, knowledgeBaseList, tempSelectedKnowledgeIds, knowledgeSelectorTarget, selectedKnowledgeBaseCache,
    selectedKnowledgeBases, selectedSectionKnowledgeBases, selectedTenderAnalysisKnowledgeBases, technicalVersionDialogVisible, technicalVersionLoading,
    technicalVersionRestoring, technicalVersionList, selectedTechnicalVersion, selectedTechnicalVersionSnapshot, technicalRequirementExtractVisible,
    technicalRequirementExtractLoading, technicalRequirementExtractRebuilding, technicalRequirementOutlineSyncing, technicalRequirementExtract, technicalExtractSummaryDialogVisible,
    technicalExtractSummarySaving, technicalScoreItemDialogVisible, technicalScoreItemSaving, technicalScoreItemEditingId, technicalRequirementItemDialogVisible,
    technicalRequirementItemSaving, technicalRequirementItemEditingId, technicalExtractSummaryForm, technicalScoreItemForm, technicalRequirementItemForm,
    technicalQualityCheckVisible, technicalQualityCheckLoading, technicalQualityCheckData, technicalWordCountVisible, technicalWordCountLoading,
    technicalWordCountStats, technicalDuplicateCheckData, technicalDuplicateCompressing, technicalReviewVisible, technicalReviewLoading,
    technicalConsistencyPackage, technicalReviewResult, technicalRequirementExtractTimer, requirementTypeOptions, riskLevelOptions,
    createDialog, techSteps, aiLevels, technicalSubTypeMap, technicalStep,
    technicalMode, technicalGeneratingOutline, technicalSolution, technicalOutlines, isCurrentTechnicalOutlineGenerating,
    technicalForm, technicalSubTypes, resetTechnicalWorkspace, resetBidDocumentWorkspace, workflowDocuments,
    parseReportText, parseProgress, hasTenderFile, tenderFileDisplayName, isParseRunning,
    isParseSuccess, parseStatusLabel, isPlatformUser, hasCompanyMaterial, bidDocumentContent,
    bidDocAnalysis, bidDocumentStatusLabel, canFillBidDocument, technicalOutlineLeafCount, technicalLeafNodes,
    technicalFinishedLeafCount, technicalRetryableLeafNodes, technicalRetryableLeafCount, canRetryTechnicalFailedSections, technicalGeneratePercent,
    technicalTargetWordCount, technicalActualWordCount, estimatePageCount, technicalTargetPageCount, technicalActualPageCount,
    showTechnicalStats, technicalWorkflowState, technicalActiveStep, technicalWorkflowStatusText, technicalWorkflowAlertData,
    technicalGeneratedView, selectedTechnicalLeafContent, technicalSectionContentDirty, technicalSectionEditorWordCount, selectedTechnicalLeafDisplayContent,
    canEditTechnicalOutline, canCopyTechnicalSection, canEditTechnicalSectionContent, canInsertTechnicalImage, canOptimizeTechnicalSection,
    canGenerateTechnicalContent, canRewriteTechnicalAll, canExportTechnicalWord, isGlobalAiTaskRunning, isGlobalAiTaskForCurrentTechnicalSolution,
    technicalRunningTask, technicalRunningTaskStatus, isTechnicalTaskWaiting, isTechnicalTaskRunning, isTechnicalRunningByBackend,
    hasOtherAiTaskRunning, isTechnicalRewriteRunning, technicalRunningTaskTypeLabel, technicalRunningTaskProgress, technicalRunningTaskMessage,
    technicalRunningTaskTip, isTechnicalBusy, projectNoMore, technicalGenerateButtonText, technicalRequirementExtractEmptyDescription,
    technicalRequirementTypeCountTags, technicalRequirementSummaryItems, technicalQualityItems, technicalQualityStatCards, currentTechnicalSolutionId,
    normalizeRequirementExtractPayload, normalizeQualityCheckPayload, openTechnicalRequirementExtractDrawer, loadTechnicalRequirementExtract, startTechnicalRequirementExtractPolling,
    onRebuildTechnicalRequirementExtract, onSyncTechnicalRequirementExtractToOutline, openTechnicalExtractSummaryDialog, onSaveTechnicalExtractSummary, openTechnicalScoreItemDialog,
    nextTechnicalScoreItemSortNo, onSaveTechnicalScoreItem, onDeleteTechnicalScoreItem, openTechnicalRequirementItemDialog, nextTechnicalRequirementItemSortNo,
    onSaveTechnicalRequirementItem, onDeleteTechnicalRequirementItem, openTechnicalQualityCheckDrawer, loadTechnicalQualityCheck, openTechnicalWordCountDrawer,
    loadTechnicalWordCountStats, onCompressTechnicalDuplicates, openTechnicalReviewDrawer, runTechnicalAiReviewNow, safePercent,
    qualityLevelTagType, qualityProgressStatus, issueSeverityTagType, qualityRowClassName, wordStatusTagType,
    requirementTypeLabel, requirementTypeTagType, handleBidProjectVisibilityChange, startGlobalAiTaskPolling, loadGlobalAiRunningTask,
    technicalDisplayStatus, patchSelectedProjectTechnicalStatus, buildWorkflowDocuments, defaultDocuments, doc,
    statusLabel, statusType, statusDotClass, projectStatusSummary, onKeywordInput,
    loadProjects, onProjectListScroll, selectProject, isProjectExpanded, toggleProjectFold,
    refreshWorkflow, defaultTenderAnalysisKnowledgeIds, openTenderAnalysisDialog, runProjectTenderAnalysis, openCreateProject,
    loadCreateEnterprises, remoteSearchCreateEnterprises, onCreateEnterpriseVisibleChange, onCreateEnterpriseChange, closeCreateDialog,
    resetUploadFile, onTenderFileChange, onTenderFileExceed, onTenderFileRemove, uploadTenderOnly,
    triggerTechnicalTenderUpload, onTechnicalTenderFileChange, startReadTenderForSelected, startReadTenderFromTechnical, autoFillProjectBasicInfo,
    openDocument, openDocumentByType, confirmDeleteProject, loadBidDocumentDetail, refreshBidDocument,
    openCompanyMaterialSelector, confirmCompanyMaterialBind, unbindSelectedCompanyMaterial, smartFillBidDocument, saveBidDocumentDraft,
    hydrateBidDocumentReviewForm, bidDocumentReviewStatusText, saveBidDocumentReview, exportBidDocumentWordFile, exportBidDocumentMarkdownFile,
    materialTypeLabel, loadTechnicalSolution, hydrateTechnicalOutlinesFromSolution, mapSolutionOutlineNode, syncTechnicalOutlineTree,
    technicalOutlineTreeSignature, reconcileTechnicalOutlineArray, reconcileTechnicalOutlineNode, normalizeAiLevel, requireSelectedTechnicalAiLevel,
    hydrateTechnicalSolutionForm, extractTechnicalRequirement, autoFillTechnicalRequirementAfterParse, generateTechnicalOutline, normalizeId,
    uniqueIds, normalizeKnowledgeIds, parseKnowledgeIds, stringifyKnowledgeIds, buildSelectedKnowledgeBases,
    collectTechnicalFullGenerateKnowledgeIds, getCurrentKnowledgeIdsByTarget, setCurrentKnowledgeIdsByTarget, goKnowledgeBasePage, openKnowledgeSelector,
    loadKnowledgeBases, confirmKnowledgeSelection, removeSelectedKnowledgeBase, openWordPresetDialog, technicalNeedsWordPreset,
    technicalNeedsWordPresetForAction, resetWordPresetSelection, setWordPreset, buildSectionWordPresetAction, isSectionWordPresetAction,
    parseSectionWordPresetAction, applyTechnicalWordPreset, handleFullGenerateBlindChange, resetFullGenerateBlindSetting, openTechnicalFullGenerateDialog,
    confirmTechnicalFullGenerate, fullGeneratePreferenceText, mergePreferenceIntoRequirement, applyTechnicalFullGeneratePreferences, startTechnicalFullGenerate,
    markTechnicalTaskPending, clearTechnicalTaskPending, restoreTechnicalTaskPending, startTechnicalTaskPolling, technicalTaskTypeLabel,
    safeTechnicalTaskMessage, cancelCurrentTechnicalTask, pollTechnicalGenerationTask, notifyTechnicalTaskTerminal, technicalLeafTitle,
    briefTechnicalNodeList, buildTechnicalExportWarnings, confirmTechnicalExportBeforeDownload, notifyTechnicalWordExportSuccess, chooseExportFormat,
    escapeHtml, internalInfoHtml, showTechnicalWordCountCheck, showTechnicalQualityCheck, showTechnicalDuplicateCheck,
    reviewTechnicalByAi, exportTechnical, waitTechnicalExportTask, sleep, markTechnicalOutlinePending,
    clearTechnicalOutlinePending, restoreTechnicalOutlinePending, startTechnicalOutlinePolling, isTechnicalOutlineGeneratingStatus, technicalOutlineFailureMessage,
    technicalOutlinesNeedWordPreset, checkTechnicalOutlineReady, getTechnicalOutlinesFromSolution, flattenTechnicalLeaves, isTechnicalNodeOptimizing,
    isTechnicalLeafDone, technicalNodeStatusLabel, technicalNodeStatusType, getTechnicalLeafContent, markTechnicalManualSelection,
    clearTechnicalManualSelection, selectTechnicalLeaf, syncSelectedTechnicalLeaf, syncTechnicalOverallRequirement, toggleTechnicalEditMode,
    reloadTechnicalAfterOutlineEdit, onTechnicalNodeWordChange, onTechnicalBatchWord, onSaveTechnicalOverallRequirement, streamTechnicalOverallDirection,
    onTechnicalAiWriteDirection, onTechnicalSaveWritingConfig, openTechnicalAddNodeDialog, onTechnicalAddNode, onTechnicalDeleteNodes,
    onTechnicalMoveNode, normalizeSectionContent, startEditTechnicalSectionContent, confirmDiscardTechnicalSectionContentChanges, cancelEditTechnicalSectionContent,
    copyTechnicalSectionContent, fallbackCopyText, SECTION_OPTIMIZE_REQUIREMENT_MARKER, sectionStoredWritingRequirement, sectionOptimizeInstruction,
    sectionOptimizeWritingRequirement, sectionOptimizeTargetWordCount, optimizeActionLabel, maxAcceptableFrontendWords, openTechnicalShortenDialog,
    confirmTechnicalShortenSection, optimizeTechnicalSection, countTextWords, formatDateTime, parseVersionSnapshot,
    currentTechnicalSectionWordCount, openTechnicalVersionDialog, selectTechnicalVersion, onRestoreTechnicalVersion, onRestoreTechnicalVersionSection,
    openTechnicalImagePicker, insertTechnicalImage, buildImageMarker, buildTechnicalImageMarker, sanitizeImageCaption,
    normalizeImageWidth, normalizeImageAlign, parseTechnicalImageMarker, findTechnicalImageLineIndex, applyTechnicalImageMarkerChange,
    focusTechnicalSectionEditor, updateTechnicalImageWidth, updateTechnicalImageAlign, editTechnicalImageCaption, deleteTechnicalImageReference,
    saveTechnicalSectionContent, selectFirstGeneratedTechnicalLeaf, selectLatestTechnicalPreviewLeaf, findTechnicalOutlineNodeById, openTechnicalSectionDialog,
    generateTechnicalSection, startPolling, isOutlineGenerated, isOutlineFailed, isTechnicalLeafRetryable,
    outlineActualWordCount, outlineTargetWordCount, technicalWordHealthClass, technicalWordHealthLabel, technicalWordHealthType,
    ImageLibraryPicker, SectionContentPreview, OutlineTree, WritingDirectionEditor, ArrowDown,
    Close, Delete, Document, EditPen, Loading,
    Plus, Refresh, Search, SortDown, SortUp,
    UploadFilled
  }
}
