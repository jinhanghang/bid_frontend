...
const routes = [
  { path: '/login', component: Login, meta: { title: '登录', public: true } },
  {
    ...
    children: [
      ...
      { path: 'system/enterprises', component: GenericCrudView, meta: { title: '企业管理', configKey: 'enterprise' } },
      { path: 'system/files', component: GenericCrudView, meta: { title: '文件资源', configKey: 'fileResource' } },
